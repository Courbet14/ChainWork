  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-sm mx-auto p-6 bg-white rounded-2xl shadow-xl border border-gray-100">
      ...
      <div>
        ...
        <input 
          type="text" 
          placeholder="例: project-a (空欄時は自動生成)" 
          value={roomId} 
      ...
      <button 
        ...
        className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-sm shadow-md disabled:opacity-50 transition-colors"
      >
